...
def test1():
    ...
    print(platform.platform())  # Linux-4.4.0-170-generic-x86_64-with-Ubuntu-16.04-xenial
    print(platform.platform(terse=True))  # Linux-4.4.0-170-generic-x86_64-with-glibc2.9
