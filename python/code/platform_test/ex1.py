...
def info_system():
    ans = {
        ...
        ),  # on macos: ('64bit', ''), on linux: ('64bit', 'ELF')
        'version': platform.version(),
        # Darwin Kernel Version 15.3.0: Thun Dec 10 18:40:58 PST 2015; root:xnu-3248.30-4~1/RELEASE_X86_64
        # #199-Uubuntu SMP Thu Nov 14 01:45:04 UTC 2019
        'processor': platform.processor(),  # i386
        'python': platform.python_version(),  # 3.7.5
    }
    print(ans)
